...
namespace lve
{
  ...
  void LveDevice::checkExtention()
  {
    ...
    // Check if VK_KHR_portability_subset is among the available extensions
    ...
    {
      throw std::runtime_error("VK_KHR_portability_subset extension not available.");
    }
  }
  ...
  void LveDevice::createInstance()
  {
    ...
    createInfo.flags = VK_INSTANCE_CREATE_ENUMERATE_PORTABILITY_BIT_KHR; // for macos support
    createInfo.pApplicationInfo = &appInfo;

    auto extensions = getRequiredExtensions();
    extensions.push_back("VK_KHR_portability_enumeration"); // for macos support
